...
export const topoNodes: TopoNode[] = [
  ...
  { id: "homeassistant", label: "Home Assistant", icon: "🏠", type: "service", x: 0.92, y: 0.78, color: "#18bcf2", tooltip: "192.168.1.16:8123", serviceIdx: 10 },
  { id: "nginx", label: "nginx-ingress", icon: "🌐", type: "infra", x: 0.15, y: 0.55, color: "#009639", tooltip: "LB 192.168.1.21" },
  { id: "dns", label: "homelab-dns", icon: "🔤", type: "infra", x: 0.55, y: 0.55, color: "#4a90d9", tooltip: "DNS 192.168.1.22" },
];
...
export const topoLinks: TopoLink[] = [
  ...
  { source: "cilium", target: "nginx", style: "solid", color: "#3fb950" },
  { source: "cilium", target: "dns", style: "solid", color: "#3fb950" },
